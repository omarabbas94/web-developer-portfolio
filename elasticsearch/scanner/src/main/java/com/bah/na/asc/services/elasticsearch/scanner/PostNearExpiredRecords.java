...
public class PostNearExpiredRecords
{
	 ...
	 * @since 1.0
	 */
	public void writeRecordMetadataToElasticsearch(
			int daysToExpire )
			throws Exception {
				...
				brb.add(esConnection
						...
						.setSource(
								XContentFactory
										.jsonBuilder()
										.startObject()
										.field("uid", recordMetadata.getId())
										.field("email", recordMetadata.getEmail())
										.field("expdate", recordMetadata.getExpires())
										.endObject()));
				indexId++;
			}
		}
